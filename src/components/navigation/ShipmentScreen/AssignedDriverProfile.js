...
export const AssignedDriverProfile = () => {
  ...
  const {courrier} = useSelector(selectCurrentShipmentStatus);
  const vehicle = courrier?.vehicle;
  return (
    <Container>
      <ComponentContainer>
        <ProfileImage
        ...
        />
        <UserText>{courrier?.name}</UserText>
      </ComponentContainer>
      <ComponentContainer>
        <IconButton
          disabled
