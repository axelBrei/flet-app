...
export const AssignedDriverProfile = () => {
  const {courrier} = useSelector(selectCurrentShipment);
  const vehicle = courrier.vehicle?.[0];
  return (
    <Container>
      <ComponentContainer>
        <ProfileImage
...
const ProfileImage = styled(Image)`
  ...
  margin: ${scaleDpTheme(5)};
`;

const UserText = styled(AppText)`
  flex: 1;
  line-height: ${scaleDpTheme(18)};
`;
